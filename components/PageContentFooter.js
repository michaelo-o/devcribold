                    ...
                    <div className={styles.report}>
                        ...
                        {reportErrorTab ? (
                            <div className={styles.reportmessage}>
                                ...
                                <br />
                                <iframe height="200" style={{ width: "90%" }} src="https://docs.google.com/forms/d/e/1FAIpQLScTtgIG7nkwPrUKHsnFIAPt3rddVJ5l9gZq6TeYXT0KslVN6Q/viewform?embedded=true" frameBorder="no">Loading…</iframe>
                            </div>
                        ) : null}
                    </div>
