...
const Paragraphs = () => {
    ...
    return (
        <>
            <Head>
                <title>HTML Paragraphs | Dev Crib</title>
            ...
            <div className={styles.gentutbackground}>
                ...
                <div className={styles.pagecontent}>
                    ...
                    <div className={styles.nextbutcont}>
                        <Link href="/tutorials/html/paragraphs">
                    ...
                    <ul>
                        <li>All HTML elements can have <b>Paragraphs</b></li>
                        <li>Paragraphs provide <b>additional information</b> about elements</li>
                        <li>Paragraphs are always specified in <b>the start tag</b></li>
                        <li>Paragraphs usually come in name/value pairs like: <b>name=&quot;value&quot;</b></li>
                    </ul>
                    ...
                    <h2>The width and height Paragraphs</h2>
                    <p>The <span className={styles.exptag}>&lt;img&gt;</span> tag should also contain the
                        <span className={styles.exptag}>width</span> and <span className={styles.exptag}>
                            height</span> Paragraphs, which specifies the width and
                    ...
                    <h2>We Suggest: Always Use Lowercase Paragraphs</h2>
                    <p>The HTML standard does not require lowercase attribute names.</p>
                    <p>The title attribute (and all other Paragraphs) can be written with uppercase or lowercase
                        like <strong>title</strong> or <strong>TITLE</strong>.</p>
                    <p>However, W3C <strong>recommends</strong> lowercase Paragraphs in HTML, and <strong>demands</strong>
                        lowercase Paragraphs for stricter document types like XHTML.</p>
                    ...
                    <ul>
                        <li>All HTML elements can have <strong>Paragraphs</strong></li>
                        ...
                        <li>The <span className={styles.exptag}>width</span> and <span className={styles.exptag}>height</span> Paragraphs
