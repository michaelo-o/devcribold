...
const Colors = () => {
    ...
    return (
        <>
            <Head>
                <title>HTML Colors | Dev Crib</title>
            ...
            <div className={styles.gentutbackground}>
                ...
                <div className={styles.pagecontent}>
                    ...
                    <ul>
                        <li>All HTML elements can have <b>Colors</b></li>
                        <li>Colors provide <b>additional information</b> about elements</li>
                        <li>Colors are always specified in <b>the start tag</b></li>
                        <li>Colors usually come in name/value pairs like: <b>name=&quot;value&quot;</b></li>
                    </ul>
                    ...
                    <h2>The width and height Colors</h2>
                    <p>The <span className={styles.exptag}>&lt;img&gt;</span> tag should also contain the
                        <span className={styles.exptag}>width</span> and <span className={styles.exptag}>
                            height</span> Colors, which specifies the width and
                    ...
                    <h2>We Suggest: Always Use Lowercase Colors</h2>
                    <p>The HTML standard does not require lowercase attribute names.</p>
                    <p>The title attribute (and all other Colors) can be written with uppercase or lowercase
                        like <strong>title</strong> or <strong>TITLE</strong>.</p>
                    <p>However, W3C <strong>recommends</strong> lowercase Colors in HTML, and <strong>demands</strong>
                        lowercase Colors for stricter document types like XHTML.</p>
                    ...
                    <ul>
                        <li>All HTML elements can have <strong>Colors</strong></li>
                        ...
                        <li>The <span className={styles.exptag}>width</span> and <span className={styles.exptag}>height</span> Colors
