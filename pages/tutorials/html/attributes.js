...
const Attributes = () => {
    ...
    return (
        <>
            <Head>
                <title>HTML Attributes | Dev Crib</title>
            ...
            <div className={styles.gentutbackground}>
                ...
                <div className={styles.pagecontent}>
                    ...
                    <div className={styles.nextbutcont}>
                        ...
                        <Link href="/tutorials/html/headings">
                    ...
                    <p>The <span className={styles.exptag}>&lt;img&gt;</span> tag should also contain the
                        <span className={styles.exptag}>width</span> and <span className={styles.exptag}>
                            height</span> attributes, which specifies the width and
                ...
                <ul>
                    ...
                    <li>The <span className={styles.exptag}>width</span> and <span className={styles.exptag}>height</span> attributes
