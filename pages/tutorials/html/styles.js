...
const Styles = () => {
    ...
    return (
        <>
            <Head>
                <title>HTML Styles | Dev Crib</title>
            ...
            <div className={styles.gentutbackground}>
                ...
                <div className={styles.pagecontent}>
                    ...
                    <ul>
                        <li>All HTML elements can have <b>Styles</b></li>
                        <li>Styles provide <b>additional information</b> about elements</li>
                        <li>Styles are always specified in <b>the start tag</b></li>
                        <li>Styles usually come in name/value pairs like: <b>name=&quot;value&quot;</b></li>
                    </ul>
                    ...
                    <h2>The width and height Styles</h2>
                    <p>The <span className={styles.exptag}>&lt;img&gt;</span> tag should also contain the
                        <span className={styles.exptag}>width</span> and <span className={styles.exptag}>
                            height</span> Styles, which specifies the width and
                    ...
                    <h2>We Suggest: Always Use Lowercase Styles</h2>
                    <p>The HTML standard does not require lowercase attribute names.</p>
                    <p>The title attribute (and all other Styles) can be written with uppercase or lowercase
                        like <strong>title</strong> or <strong>TITLE</strong>.</p>
                    <p>However, W3C <strong>recommends</strong> lowercase Styles in HTML, and <strong>demands</strong>
                        lowercase Styles for stricter document types like XHTML.</p>
                    ...
                    <ul>
                        <li>All HTML elements can have <strong>Styles</strong></li>
                        ...
                        <li>The <span className={styles.exptag}>width</span> and <span className={styles.exptag}>height</span> Styles
