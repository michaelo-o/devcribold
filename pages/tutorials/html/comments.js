...
const Comments = () => {
    ...
    return (
        <>
            <Head>
                <title>HTML Comments | Dev Crib</title>
            ...
            <div className={styles.gentutbackground}>
                ...
                <div className={styles.pagecontent}>
                    ...
                    <div className={styles.nextbutcont}>
                        ...
                        <Link href="/tutorials/html/colors">
                    ...
                    <ul>
                        <li>All HTML elements can have <b>Comments</b></li>
                        <li>Comments provide <b>additional information</b> about elements</li>
                        <li>Comments are always specified in <b>the start tag</b></li>
                        <li>Comments usually come in name/value pairs like: <b>name=&quot;value&quot;</b></li>
                    </ul>
                    ...
                    <h2>The width and height Comments</h2>
                    <p>The <span className={styles.exptag}>&lt;img&gt;</span> tag should also contain the
                        <span className={styles.exptag}>width</span> and <span className={styles.exptag}>
                            height</span> Comments, which specifies the width and
                    ...
                    <h2>We Suggest: Always Use Lowercase Comments</h2>
                    <p>The HTML standard does not require lowercase attribute names.</p>
                    <p>The title attribute (and all other Comments) can be written with uppercase or lowercase
                        like <strong>title</strong> or <strong>TITLE</strong>.</p>
                    <p>However, W3C <strong>recommends</strong> lowercase Comments in HTML, and <strong>demands</strong>
                        lowercase Comments for stricter document types like XHTML.</p>
                    ...
                    <ul>
                        <li>All HTML elements can have <strong>Comments</strong></li>
                        ...
                        <li>The <span className={styles.exptag}>width</span> and <span className={styles.exptag}>height</span> Comments
