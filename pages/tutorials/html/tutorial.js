            ...
            <div className={styles.gentutbackground}>
                ...
                <div className={styles.pagecontent}>
                    ...
                    <div className={styles.nextbutcont}>
                        <Link href="/tutorials/html/tutorial">
                    ...
                    <ul>
                        <li>All HTML elements can have <b>Tutorial</b></li>
                        <li>Tutorial provide <b>additional information</b> about elements</li>
                        <li>Tutorial are always specified in <b>the start tag</b></li>
                        <li>Tutorial usually come in name/value pairs like: <b>name=&quot;value&quot;</b></li>
                    </ul>
                    ...
                    <p>There are two ways to specify the URL in the <span className={styles.exptag}>src</span>
                        attribute:</p>
                    <p><strong>1. Absolute URL</strong> - Tutorial to an external image that is hosted
                    ...
                    <p><strong>Notes:</strong> External images might be under copyright. If you do
                        ...
                        changed.</p>
                    <p><strong>2. Relative URL</strong> - Tutorial to an image that is hosted within
                    ...
                    <h2>The width and height Tutorial</h2>
                    <p>The <span className={styles.exptag}>&lt;img&gt;</span> tag should also contain the
                        <span className={styles.exptag}>width</span> and <span className={styles.exptag}>
                            height</span> Tutorial, which specifies the width and
                    ...
                    <h2>We Suggest: Always Use Lowercase Tutorial</h2>
                    <p>The HTML standard does not require lowercase attribute names.</p>
                    <p>The title attribute (and all other Tutorial) can be written with uppercase or lowercase
                        like <strong>title</strong> or <strong>TITLE</strong>.</p>
                    <p>However, W3C <strong>recommends</strong> lowercase Tutorial in HTML, and <strong>demands</strong>
                        lowercase Tutorial for stricter document types like XHTML.</p>
                    ...
                    <ul>
                        <li>All HTML elements can have <strong>Tutorial</strong></li>
                        ...
                        <li>The <span className={styles.exptag}>width</span> and <span className={styles.exptag}>height</span> Tutorial
