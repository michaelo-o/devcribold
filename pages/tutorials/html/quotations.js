...
const Quotations = () => {
    ...
    return (
        <>
            <Head>
                <title>HTML Quotations | Dev Crib</title>
            ...
            <div className={styles.gentutbackground}>
                ...
                <div className={styles.pagecontent}>
                    ...
                    <div className={styles.nextbutcont}>
                        <Link href="/tutorials/html/formatting">
                            <a className={styles.prevbut}>Previous</a>
                        </Link>
                        <Link href="/tutorials/html/comments">
                    ...
                    <ul>
                        <li>All HTML elements can have <b>Quotations</b></li>
                        <li>Quotations provide <b>additional information</b> about elements</li>
                        <li>Quotations are always specified in <b>the start tag</b></li>
                        <li>Quotations usually come in name/value pairs like: <b>name=&quot;value&quot;</b></li>
                    </ul>
                    ...
                    <h2>The width and height Quotations</h2>
                    <p>The <span className={styles.exptag}>&lt;img&gt;</span> tag should also contain the
                        <span className={styles.exptag}>width</span> and <span className={styles.exptag}>
                            height</span> Quotations, which specifies the width and
                    ...
                    <h2>We Suggest: Always Use Lowercase Quotations</h2>
                    <p>The HTML standard does not require lowercase attribute names.</p>
                    <p>The title attribute (and all other Quotations) can be written with uppercase or lowercase
                        like <strong>title</strong> or <strong>TITLE</strong>.</p>
                    <p>However, W3C <strong>recommends</strong> lowercase Quotations in HTML, and <strong>demands</strong>
                        lowercase Quotations for stricter document types like XHTML.</p>
                    ...
                    <ul>
                        <li>All HTML elements can have <strong>Quotations</strong></li>
                        ...
                        <li>The <span className={styles.exptag}>width</span> and <span className={styles.exptag}>height</span> Quotations
