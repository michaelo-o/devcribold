...
const CssInHtml = () => {
    ...
    return (
        <>
            <Head>
                <title>HTML CssInHtml | Dev Crib</title>
            ...
            <div className={styles.gentutbackground}>
                ...
                <div className={styles.pagecontent}>
                    <StickyNav />
                    <h1>HTML CssInHtml</h1>

                    <div className={styles.nextbutcont}>
                        <Link href="/tutorials/html/styles">
                            <a className={styles.prevbut}>Previous</a>
                        </Link>
                        <Link href="/tutorials/html/quotations">
                            <a className={styles.nextbut}>Next</a>
                        </Link>
                    </div>

                    <h2>HTML CssInHtml</h2>
                    ...
                    <ul>
                        <li>All HTML elements can have <b>CssInHtml</b></li>
                        <li>CssInHtml provide <b>additional information</b> about elements</li>
                        <li>CssInHtml are always specified in <b>the start tag</b></li>
                        <li>CssInHtml usually come in name/value pairs like: <b>name=&quot;value&quot;</b></li>
                    </ul>
                    ...
                    <h2>The width and height CssInHtml</h2>
                    <p>The <span className={styles.exptag}>&lt;img&gt;</span> tag should also contain the
                        <span className={styles.exptag}>width</span> and <span className={styles.exptag}>
                            height</span> CssInHtml, which specifies the width and
                    ...
                    <h2>We Suggest: Always Use Lowercase CssInHtml</h2>
                    <p>The HTML standard does not require lowercase attribute names.</p>
                    <p>The title attribute (and all other CssInHtml) can be written with uppercase or lowercase
                        like <strong>title</strong> or <strong>TITLE</strong>.</p>
                    <p>However, W3C <strong>recommends</strong> lowercase CssInHtml in HTML, and <strong>demands</strong>
                        lowercase CssInHtml for stricter document types like XHTML.</p>
                    ...
                    <ul>
                        <li>All HTML elements can have <strong>CssInHtml</strong></li>
                        ...
                        <li>The <span className={styles.exptag}>width</span> and <span className={styles.exptag}>height</span> CssInHtml
