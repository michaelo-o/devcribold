...
const RWD = () => {
    ...
    return (
        <>
            <Head>
                <title>CSS Responsive Web Design | Dev Crib</title>
            ...
            <div className={styles.gentutbackground}>
                ...
                <div className={styles.pagecontent}>
                    ...
                    <h1>CSS Responsive Web Design</h1>
                    ...
                    <div className={styles.extraborder}>
                        <div className="embedDiv">
                            <iframe height="500" style={{ "width": "80%" }}
                                scrolling="no" title="CSS RWD" src="https://codepen.io/_michaeli/embed/JjLKmoB?default-tab=css%2Cresult&editable=true&theme-id=dark" frameBorder="no" loading="lazy" allowtransparency="true" allowFullScreen={true}>
